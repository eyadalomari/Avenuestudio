...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('users')->insert([
            ['name' => 'Admin', 'mobile' => '079999999', 'email' => 'admin@avenue.com', 'role_id' => 1, 'is_active' => 1, 'password' => Hash::make('Demo@123')],
            ['name' => 'Eyad', 'mobile' => '0795473804', 'email' => 'eyad@avenue.com', 'role_id' => 1, 'is_active' => 1, 'password' => Hash::make('Demo@123')],
